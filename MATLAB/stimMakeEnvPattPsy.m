...
%       env.taper = cosine-taper fraction (0.0 to 1.0) for 'gabor'
%       env.phase MUST be 0 or 180
%       env.shift =, for 'halfDisc'
%       env.lambda, .aspect, .spBand, ... - parameters shift of boundary from centre, in pixels, for 'halfDisc'
